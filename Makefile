SRCS = ast_1.c ast_2.c ast_3.c cd.c cmd.c delete_env.c echo.c env.c execute_bl.c execute_cmd_line.c execution_1.c execution_util_1.c execution_util_2.c execution_util_3.c execution_util_4.c exit.c export.c \
       ...
       ft_substr.c ft_tolower.c get_env.c init_minishell.c lexer.c lexer_collect_double_quote_1.c lexer_collect_double_quote_2.c lexer_collect_double_quote_3.c lexer_collect_env_1.c lexer_collect_env_2.c \
	   lexer_collect_env_3.c lexer_collect_env_4.c lexer_collect_id.c lexer_collect_meta.c lexer_collect_parenthesis.c lexer_collect_single_quote_1.c lexer_simple_caraters.c lexer_token_ast_free_1.c \
	   lexer_token_ast_free_2.c lexer_utile_1.c lexer_utile_2.c lexer_utile_3.c lexer_utile_4.c main.c new_prompt.c node_1.c node_2.c node_3.c node_4.c pwd.c scan_grammar_1.c scan_grammar_2.c signal.c \
	   token.c unlink_herdocfiles.c unset.c visitor_creat_output_file_1.c visitor_creat_output_file_2.c visitor_herdoc_1.c visitor_herdoc_2.c visitor_wildcards_1.c visitor_wildcards_2.c \
	   visitor_expan_redirection_1.c visitor_expan_redirection_2.c visitor_expan_redirection_3.c
