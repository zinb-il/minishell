SRCS = ast_1.c ast_2.c ast_3.c cd.c cmd.c delete_env.c echo.c env.c execute_bl.c execute_cmd_line.c execution_1.c execution_util_1.c execution_util_2.c execution_util_3.c execution_util_4.c exit.c export.c \
       ...
       ft_substr.c ft_tolower.c get_env.c init_minishell.c lexer.c lexer_collect_double_quote_1.c lexer_collect_double_quote_2.c lexer_collect_env_1.c lexer_collect_env_2.c lexer_collect_env_3.c lexer_collect_env_4.c \
	   lexer_collect_id.c lexer_collect_meta.c \
